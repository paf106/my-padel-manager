...
function isActive(pathname: string, href: string) {
  ...
  if (href === "/calendar")
    return pathname.startsWith("/calendar") || pathname.startsWith("/classes");
  return pathname.startsWith(href);
}

const icons = {
  home: CircleDollarSign,
  ...
  if (variant === "bottom") {
    return (
      <Link
        ...
        className={cn(
          "flex min-h-11 flex-1 flex-col items-center gap-1 text-xs font-bold",
